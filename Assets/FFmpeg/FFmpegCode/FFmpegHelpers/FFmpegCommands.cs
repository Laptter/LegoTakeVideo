...
public static class FFmpegCommands
{
    ...
    public const string ASYNC = "-async 1";
    //------------------------------
    ...
    static string GetBitRate(string biteRate)
    {
        if (String.IsNullOrEmpty(biteRate))
        {
            biteRate = "16000k";
        }
        return "-b " + biteRate;
    ...
    static string SetFrameRate(int frameRate)
    {
        return string.Format("-r {0}", frameRate);
    }
